...
const CreateProdect = () => {
  ...
  const [createProdect, { isLoading: loding, error, isSuccess }] =
  ...
  useEffect(() => {
    if (isSuccess) {
      toast.success("Prodect Created Successfull");
  ...
  const hanldeForm = async (e) => {
    ...
    if (
      ...
      (image2.type !== "image/jpg" &&
        image2.type !== "image/jpeg" &&
        image2.type !== "image/png") ||
      (image3.type !== "image/jpg" &&
        image3.type !== "image/jpeg" &&
        image3.type !== "image/png")
    ) {
      ...
      <form onSubmit={hanldeForm}>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="">
            ...
            <div className="mb-6">
              <label htmlFor="" className="text-gray-400 capitalize">
                image 1
              </label>
              <input
                type="file"
                onChange={(e) => setImage1(e.target.files[0])}
                className="file:px-4 mt-2 file:py-3 file:bg-indigo-600 file:border-none file:cursor-pointer file:text-white file:rounded file:font-semibold"
              />
            </div>
            <div className="mb-6">
              <label htmlFor="" className="text-gray-400 capitalize">
